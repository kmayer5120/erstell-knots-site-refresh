...
const Nav = () => {
  return (
    ...
    <nav className="nav">
      <ul>
        <li className="nav__item pr-1 active">
          <Link className="navbar__link" to="https://erstellknots.com/">
        ...
        <li className="nav__item pr-1">
          <Link className="navbar__link" to="#about-me">
        ...
        <li className="nav__item pr-1">
          <Link className="navbar__link" to="#image-grid">
