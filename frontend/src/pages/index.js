    ...
    <>
      <body>
        ...
        <header class="container">
          <div class="hero">
            <div class="row">
              ...
              <div class="col-sm-6 hero__content">
                <div class="hero__text">The best is handmade</div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          >
            <span class="navbar-toggler-icon" id="hamburger-menu-icon"></span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item pr-4 active">
                <a class="nav-link" href="https://erstellknots.com/">
              ...
              <li class="nav-item pr-4">
                <a class="nav-link" href="#image-grid">
      ...
      "
        >
          <div class="row px-2" id="about-me-wrapper">
            <div
              class="
            col-lg-6 col-md-12
            px-3
          ...
          "
              id="about-me"
            >
              <h2 class="py-2">About Erstell Knots</h2>
              <p class="pt-2">
            ...
            <div class="col-lg-6 col-md-12 px-3 my-3">
              <div class="container announcements">
                <h2>Finding Summer Barefoot Sandals</h2>

                <div class="announcements__countdown">
                  <p id="countdown">
                    PATTERN RELEASE:
                    <span id="days"></span>
                    <span id="hours"></span>
                ...
                <div class="announcements__img-grid">
                  <img
                    src="#"
                ...
                <div class="announcements__body mt-2">
                  Are you looking for a
                  <span class="color-blueberry text-bold">super quick</span> and
                  <span class="color-blueberry text-bold">
                    fun pattern?
                  </span>{' '}
              ...
              <h3 class="py-2 mt-3">The Best Is Handmade</h3>
              <img
                src="#"
        ...
        {/* <!--end about--> */}
        <section class="image-grid__section">
          <div class="container image-grid" id="image-grid"></div>
        </section>
        {/* <!-- services --> */}
        <section class="container">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12" id="services-tools">
                  {/* <!--start modal--> */}
                  <a href="#tools-modal" role="button" data-toggle="modal">
                    <img
                      src="#"
                  ...
                  <div class="modal fade show" id="tools-modal" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body" id="tools-modal-content">
                          <img
                            src="#"
                            data-src="./images/misc-images/tools.jpeg"
                            alt="tools"
              ...
              <div
                ...
                id="links-container"
              >
                <h3 class="mt-3" id="links-description">
                  Find me here:
                </h3>
                <div
                  class="
              ...
              "
                >
                  <div class="etsy-ravelry-svg-links-container">
                    <a
                      href="https://www.etsy.com/shop/ErstellKnots"
                      target="_blank"
                      rel="noreferrer"
          ...
          "
            ...
            >
              ...
              <p class="pt-2">
                ...
                <a href="#contact">reach out</a> to us if you’d like to
                collaborate on a pattern together.
              </p>
              <h5 class="pt-2">Custom patterns:</h5>
              <p class="pt-2">
                If there is an item you’d like a pattern for but can’t seem to
                find a pattern you like, you can
                <a href="#contact">reach out</a> to us and we can work together
              ...
              <h5 class="pt-2">Custom Crochet Products:</h5>
              <p class="pt-2">
        ...
        {/* <!--end services --> */}
        {/* <!-- contact form --> */}
        <section class="container-fluid mt-5" id="contact-wrapper">
          <form
            action="./apis/"
            id="contact"
            method="post"
          ...
          >
            ...
            ></div>
            <div class="form-group">
              <button id="btn-send" class="py-2" type="submit">
                SEND
              </button>
            </div>
          ...
          <div class="row">
            <footer class="footer">
              ...
              <div class="footer__created-by">
                <div class="px-2">Created By: Kyle Mayer</div>
                <a
